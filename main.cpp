...
using vector_t = std::vector<std::pair<int, int>>;

vector_t zoom_in_test_all_white = {
    {0, 0},
    {0, 0},
    {0, 0},
    {0, 0},
...
vector_t zoom_in_test_all_black = {
...
void zoom_in_test(mandelbrot &img, vector_t test_coords,
